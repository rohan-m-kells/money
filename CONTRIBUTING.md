Contributing to $ Money Core
=============================

The $ Money Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "$ Money Core
...
Before you start contributing, familiarize yourself with the $ Money Core build
system and tests. Refer to the documentation in the repository on how to build
$ Money Core and how to run the unit tests, functional tests, and fuzz tests.

You may also participate in the [$ Money Core PR Review Club](https://moneycore.reviews/).

Communication Channels
----------------------

Most communication about $ Money Core development happens on IRC, in the
`#money-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#money-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/money-core-dev/](https://www.erisian.com.au/money-core-dev/)
and [https://gnusha.org/money-core-dev/](https://gnusha.org/money-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/moneydev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/moneydev/](https://gnusha.org/pi/moneydev/).
...
For GUI-related issues or pull requests, the https://github.com/money-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/rohan-m-kells/money node repository should be used.

The main branch for all repositories is identical.
...
the pull request affects. Valid areas are:
  ...
  - `qt` or `gui` for changes to money-qt
...
fork of $ Money Core copies the merge. Instead, make any username mentions in a
...
prefix the title with [WIP] or use [Tasks Lists](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/rohan-m-kells/money  # Fetch the latest upstream commit
...
The following applies to code changes to the $ Money Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Money
Network Protocol consensus changes.

Whether a pull request is merged into $ Money Core rests with the project merge
maintainers.
...
Patches that change Money consensus rules are considerably more involved than
...
test out the patch set and opie on the technical merits of the patch. Project
...
Where a patch set proposes to change the Money consensus, it must have been
...
https://github.com/rohan-m-kells/money/pull/1).

Also see the [backport.py script](
https://github.com/money-core/money-maintainer-tools#backport).
